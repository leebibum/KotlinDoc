...
fun sealedWhenTest(s: Sealed) {
    when (s) {
        is DerivedSealed -> println("s is DerivedSealedClass")
        is DerivedSealed2 -> println("s is DerivedSealedClass2")
    }
}